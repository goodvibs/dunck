...
pub const WHITE_CASTLING_SPACE_SHORT: Bitboard = 0x0000000000000006;
pub const WHITE_CASTLING_SPACE_LONG: Bitboard = 0x0000000000000070;
pub const BLACK_CASTLING_SPACE_SHORT: Bitboard = 0x0600000000000000;
pub const BLACK_CASTLING_SPACE_LONG: Bitboard = 0x7000000000000000;
pub const WHITE_CASTLING_CHECK_MASK_SHORT: Bitboard = WHITE_CASTLING_SPACE_SHORT & STARTING_WK;
pub const WHITE_CASTLING_CHECK_MASK_LONG: Bitboard = 0x0000000000000030 & STARTING_WK;
pub const BLACK_CASTLING_CHECK_MASK_SHORT: Bitboard = BLACK_CASTLING_SPACE_SHORT & STARTING_BK;
pub const BLACK_CASTLING_CHECK_MASK_LONG: Bitboard = 0x3000000000000000 & STARTING_BK;

pub const CASTLING_SPACE_SHORT: [Bitboard; 2] = [WHITE_CASTLING_SPACE_SHORT, BLACK_CASTLING_SPACE_SHORT];
pub const CASTLING_SPACE_LONG: [Bitboard; 2] = [WHITE_CASTLING_SPACE_LONG, BLACK_CASTLING_SPACE_LONG];
